...
public enum Config implements PeConfig {
  ...
  private final static String SERVICE_ID = "pe/flipkartv1";

  Config() {
    config = SpConfig.getSpConfig(SERVICE_ID);

    config.register(ConfigKeys.HOST, "cart", "Hostname for the pe source component");
